...
const { getEmployees, getEmployee, getMyProfile, createEmployee, updateEmployee, deleteEmployee, getStats, getEmployeeActivity } = require('../controllers/employeeController');
