...
const packageSchema = new mongoose.Schema({
  ...
  billingCycle: { type: String, enum: ['one-time', 'monthly', 'quarterly', 'yearly', 'lifetime'], default: 'one-time' },
...
const serviceSchema = new mongoose.Schema({
  ...
  priceType: { type: String, enum: ['one-time', 'monthly', 'yearly', 'lifetime'], default: 'one-time' },
