...
const { register, login, getMe, updateProfile, changePassword, getAllUsers, toggleUserStatus, createClient, updateUserByAdmin } = require('../controllers/authController');
