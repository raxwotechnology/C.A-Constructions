...
const { getAdvances, getAdvance, getEmployeeAdvanceSummary, createAdvance, updateAdvance, recordRepayment, deleteAdvance, cleanupOrphanedAdvances } = require('../controllers/advanceController');

router.use(protect, authorize('admin', 'manager'));
router.delete('/cleanup-orphaned', cleanupOrphanedAdvances);
