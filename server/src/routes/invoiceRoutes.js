...
const {
  ...
  recordPayment, recordAdvance, sendInvoice, downloadInvoicePdf, downloadPaymentReceiptPdf,
...
router.get('/:id/payments/:paymentId/receipt', protect, downloadPaymentReceiptPdf);
