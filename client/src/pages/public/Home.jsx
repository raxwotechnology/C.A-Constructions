...
import { FiArrowRight, FiCode, FiSmartphone, FiCloud, FiShield, FiTrendingUp, FiUsers, FiStar, FiChevronLeft, FiChevronRight } from 'react-icons/fi'
      ...
      <section className="relative min-h-screen bg-gradient-hero flex items-center overflow-hidden">
        ...
        <div className="container-max relative z-10 py-32">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            {/* Hero card */}
            <motion.div initial={{ opacity: 0, x: 50 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.3, duration: 0.6 }} className="hidden lg:block">
              <div className="glass-card p-8 animate-float">
                ...
                {[
                  { label: 'Active Projects', value: '12', trend: '+3 this month', color: 'bg-blue-500' },
                  { label: 'Team Members', value: '35', trend: '100% engaged', color: 'bg-accent' },
                  { label: 'Revenue (MTD)', value: 'LKR 4.2M', trend: '+18% vs last month', color: 'bg-purple-500' },
                ].map(stat => (
                  <div key={stat.label} className="flex items-center gap-3 bg-white/5 rounded-xl p-3 mb-3">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {services.map((s, i) => (
              <motion.div
                ...
                className="card card-body card-hover group cursor-pointer"
              >
                ...
                <h3 className="font-semibold text-primary font-heading mb-2">{s.title}</h3>
                <p className="text-gray-500 text-sm leading-relaxed">{s.desc}</p>
                <div className="mt-4 text-secondary font-medium text-sm flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
