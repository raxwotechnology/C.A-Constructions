...
export default function CEODashboard() {
  ...
  return (
    <div className="space-y-8 p-4 md:p-6 max-w-7xl mx-auto">
      {/* Header & Pulse Badge */}
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-gradient-to-r from-slate-900 via-slate-800 to-amber-950 p-6 rounded-2xl text-slate-900 shadow-xl">
        <div>
          ...
          <h1 className="text-2xl md:text-3xl font-bold text-slate-900">CEO & Executive Control Matrix</h1>
          <p className="text-slate-600 text-sm mt-1">Real-time capital health, forensic profit leaks & active site ecosystem.</p>
        </div>
        <div className="flex gap-3">
          <Link to="/admin/projects" className="px-4 py-2.5 bg-amber-500 hover:bg-amber-600 text-slate-950 font-semibold rounded-xl text-sm transition-all shadow-md">
            Manage All Sites
          </Link>
        </div>
      </div>
