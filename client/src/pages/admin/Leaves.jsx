...
export default function AdminLeaves() {
  ...
  const assignMut = useMutation({
    ...
    onSuccess: () => {
      ...
      setSelectedEmpId(''); setAssignForm({ employeeId:'', leaveType:'annual', status:'pending', startDate:'', endDate:'', reason:'', remarks:'' })
    },
    onError: e => toast.error(e.response?.data?.message || 'Failed'),
  })
            ...
            <div className="overflow-y-auto flex-1 p-6 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <select value={assignForm.status || 'pending'} onChange={e => setAssignForm(s=>({...s,status:e.target.value}))} className="form-select font-semibold">
