    ...
    <form onSubmit={handleSubmit(onSubmit, onInvalid)} className="p-6 space-y-5">
      ...
      <FormSection title="Employment" icon={FiBriefcase}>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div><label className="form-label">Designation *</label><input {...register('designation', { required: true })} className="form-input" placeholder="e.g. Site Engineer / Quantity Surveyor" /><FieldError message={errors.designation ? 'Required' : ''} /></div>
